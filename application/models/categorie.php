...
class Categorie extends CI_Model
{
    ...
    {
        // Busca na tabela ejs_categories_products pela coluna 'name'
        $this->db->where('category_name', $category_name);
        $query = $this->db->get('ejs_categories_products');
    ...
    {
        $this->db->where('category_id', $category_id);
        return $this->db->delete('ejs_categories_products');
    }
    ...
    {
        // Busca a categoria associada ao item na tabela 'items'
        $this->db->select('category_id');  // Seleciona o ID da categoria
        ...
        if ($item) {
            ...
            $this->db->from('ejs_categories_products');  // Supondo que a tabela de categorias seja 'ejs_categories_products'
    ...
    {
        // Insere os dados na tabela ejs_categories_products
        $this->db->insert('ejs_categories_products', $category_data);
    ...
    {
        $this->db->where('category_id', $category_id);
        return $this->db->update('ejs_categories_products', $data);
    }
}
