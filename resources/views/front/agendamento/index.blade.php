    ...
    <style>
        ...
        * {
        ...
        .card {
            ...
            margin: 10px;
            width: 100%;
            /* Alterado para largura total na tela pequena */
            cursor: pointer;
        }
    ...
    <div class="container">
        ...
        <form method="post" action="{{ route('agendamento.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="date" hidden id="data_agendamento" name="data_agendamento" value="{{ $data['data'] }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="number" name="number" value="{{ $data['phone'] }}"
                    data-inputmask="'mask': ['+55 (99) 99999-9999']">
            </div>
