...
<head>
<meta charset="utf-8">
<title>Kavin Corporate Free HTML5 Template</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta name="description" content="" />
<meta name="author" content="http://webthemez.com" />
<!-- css -->
<link href="/assets/front/css/bootstrap.min.css" rel="stylesheet" />
<link href="/assets/front/css/fancybox/jquery.fancybox.css" rel="stylesheet">
<link href="/assets/front/css/jcarousel.css" rel="stylesheet" />
<link href="/assets/front/css/flexslider.css" rel="stylesheet" />
<link href="/assets/front/js/owl-carousel/owl.carousel.css" rel="stylesheet">
...
<div id="wrapper" class="home-page">
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="/assets/front/img/logo.png" alt="logo"/></a>
                </div>
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="/assets/front/img/slides/1.jpg" alt="" />
              ...
              <li>
                <img src="/assets/front/img/slides/2.jpg" alt="" />
                <div class="flex-caption">
	...
	<div class="container">
		<div class="row">
		<div class="col-md-6"><img src="/assets/front/img/img1.png" class="img-center" alt="" /></div>
			<div class="col-md-6">
				<div><h2>Our Team</h2>
	...
	<section id="clients">
        <div class="container">
            	<div class="row">
			<div class="col-md-12">
				<div class="aligncenter"><h2 class="aligncenter">Our Clients</h2>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident, doloribus omnis minus ovident, doloribus omnis minus temporibus perferendis nesciunt..</div>
				<br/>
			</div>
		</div>
            <div class="row">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="copyright">
						<p>
							<span>&copy; Kavin 2015 All right reserved. By </span><a href="http://webthemez.com" target="_blank">WebThemez</a>
						</p>
					</div>
				</div>
				<div class="col-lg-6">
...
<script src="/assets/front/js/portfolio/jquery.quicksand.js"></script>
<script src="/assets/front/js/portfolio/setting.js"></script>
<script src="/assets/front/js/jquery.flexslider.js"></script>
